...
export function canAccessView(
  ...
  switch (view) {
    case 'dashboard':
      return hasPermission(profile, 'canViewDashboard', ['admin', 'reservations', 'client', 'external_client', 'faturamento', 'reception', 'finance', 'eventos']);
    case 'reservations':
      return hasPermission(profile, 'canViewReservations', ['admin', 'reservations', 'client', 'external_client']);
    case 'checkin':
      return hasPermission(profile, 'canPerformCheckIn', ['admin', 'reception']);
    case 'events':
